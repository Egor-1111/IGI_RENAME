...
class PromoCode(models.Model):
    ...
    tour = models.ForeignKey('Tour', on_delete=models.CASCADE)
    discount_percent = models.PositiveSmallIntegerField()  # от 1 до 100
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)  # админ или сотрудник
